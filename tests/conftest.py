...
config_stub.DROPDOWN_REFRESH_MAX_AGE_DAYS = 7
config_stub.FORCE_DROPDOWN_DISCOVERY = False
...
config_stub.FAST_PATH_MAX_CONCURRENCY = 12
config_stub.FAST_PATH_WARMUP_REQUESTS = 4
config_stub.FAST_PATH_WARMUP_DELAY_MS = 150
