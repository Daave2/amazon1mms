    ...
    async with async_playwright() as p:
        ...
        if await trigger.is_visible():
            ...
            for i in range(count):
                ...
                if ph and "shoppers" in ph.lower(): continue
            ...
            html = await options.evaluate('el => el.outerHTML') if await options.count() > 0 else (await page.evaluate('document.body.innerHTML'))
            with open("dropdown_dump.html", "w") as f: f.write(html)
